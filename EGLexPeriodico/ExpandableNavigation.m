...
//    }];
    ...
    for (UIView* view in self.menuItems) {
        ...
        CGFloat x = (self.radius + self.bounce * self.radius) * rotation.b;
        CGFloat y = (self.radius + self.bounce * self.radius) * rotation.d;
        ...
        [UIView animateWithDuration: self.speed
                         ...
                         completion:^(BOOL finished){
                             [UIView animateWithDuration:self.bounceSpeed
                                              animations:^{
                                                  CGFloat x = self.bounce * self.radius * rotation.b;
                                                  CGFloat y = self.bounce * self.radius * rotation.d;
                                                  CGPoint center = CGPointMake( view.center.x - x , view.center.y - y);
                                                  view.center = center;
